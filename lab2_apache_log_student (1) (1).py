...
dayGroupedHosts = dayToHostPairTuple.groupByKey().mapValues(lambda x: len(set(x)))

dayHostCount = dayGroupedHosts.sortByKey()
...
groupedByDay = dayAndHostTuple.groupByKey().mapValues(lambda x: (len(x)/len(set(x))))
